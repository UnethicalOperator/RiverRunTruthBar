...
> **Packaged release layout:** run `RUN\RiverRunTruthBar.exe`. The complete editable project is retained under `SOURCE` for the Rights Holder.
...
2. Double-click `RUN\RiverRunTruthBar.exe` in this packaged release.
...
Publishing the repository publicly on GitHub permits other GitHub users to view and fork it through GitHub's service under GitHub's Terms. Public visibility does not grant a broader open-source license, “no copies or forks.”
